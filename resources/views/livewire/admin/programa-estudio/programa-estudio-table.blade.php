<div class="w-full py-8 px-4 sm:px-6 lg:px-8" x-data="programaList()">
    ...
    <div class="w-full space-y-4">
        <div class="mb-6">
            ...
            <p class="text-zinc-400 mt-2">Gestiona los programas y sus módulos</p>
        </div>

        @foreach ($programas as $programa)
            <div
                class="bg-white dark:bg-slate-800 rounded-xl shadow-lg overflow-hidden border border-slate-200 dark:border-slate-700 transition-all duration-200 hover:shadow-xl">
                    ...
                    <div x-show="expandedPrograms.includes({{ $programa->id }})" x-collapse class="mt-6">
                        <div class="border-t border-slate-200 dark:border-slate-700 pt-6">
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <button @click="openModuleModal({{ $programa->id }})"
                            ...
                            <!-- Lista de módulos (placeholder) -->
                            <div class="space-y-2">
                                {{-- Aquí se mostrarán los módulos cuando se implementen --}}
                                <div
                        ...
                        <div class="p-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="module_nombre" name="nombre"
                                    class="w-full px-4 py-2 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded-lg text-slate-800 dark:text-slate-200 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                    placeholder="Ej: Desarrollo Web" required maxlength="255">
                            </div>

                            <!-- Campo Código del Módulo -->
                            <div class="mb-4">
                                <label for="module_codigo"
                                    class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
                                    Código del Módulo
                                </label>
                                <input type="text" id="module_codigo" name="codigo"
                                    class="w-full px-4 py-2 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded-lg text-slate-800 dark:text-slate-200 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                    placeholder="Ej: MOD-001" maxlength="50">
                            </div>

                            <!-- Campo Semestre -->
                            <div class="mb-4">
                                <label for="module_semestre"
                                    class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
                                    Semestre
                                </label>
                                <select id="module_semestre" name="semestre"
                                    class="w-full px-4 py-2 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded-lg text-slate-800 dark:text-slate-200 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
