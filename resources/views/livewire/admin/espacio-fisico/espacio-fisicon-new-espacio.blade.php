<template x-teleport="body">
    <div x-show="isCreateEspacioOpen" 
        ...
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            <div class="inline-block align-bottom bg-white dark:bg-slate-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full border border-slate-200 dark:border-slate-700 relative z-10">
                <form action="{{ route('admin.espacio-fisico.store') }}" method="POST" class="space-y-6">
                    @csrf
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-slate-800 dark:text-slate-200 mb-6">Agregar Espacio Físico</h3>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div data-flux-field>
                                ...
                                <input type="text" id="create_nombre" name="nombre"
